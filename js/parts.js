...
window.onload = async function () {
    ...
    document.getElementById("build-part").addEventListener("click", function () {
        ...
        window.accounts[0]='0x737005a8d5D3f1EbCa6cCc39d59c2F38865d934D'
	console.log('test1')
	...
	console.log(web3.utils.fromAscii(part_type))
	console.log(web3.utils.fromAscii(creation_date))
 	...
 	console.log("Part Hashed")
	// window.pm.methods.buildPart(serial, part_type, creation_date).enable()
